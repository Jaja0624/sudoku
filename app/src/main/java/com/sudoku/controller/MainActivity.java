    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if (theGrid.gameOver()) {
                    if (alreadyWon) {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                            newGameButton.setBackground(getResources().getDrawable(R.drawable.new_game_button));
                        }
                        Toast.makeText(MainActivity.this, "Board Complete!", Toast.LENGTH_LONG).show();
                        playWow();
                        timer.stop();
                        alreadyWon = true;
                        addEraseButton.setBackground(getResources().getDrawable(R.drawable.board_complete));
        ...
        newGameButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                    newGameButton.setBackground(getResources().getDrawable(R.drawable.new_game_button));
                    addEraseButton.setBackground(getResources().getDrawable(R.drawable.add_button));
                }
...
//                readCSV(); // must be called again
        ...
        if (listening) {
            listenOnOff = 1;
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                listenBtn.setBackground(getResources().getDrawable(R.drawable.listen_button));
            }
        }
    ...
    private void toggleListenBtn() {
        ...
        if (listenOnOff == 1) {
            ...
            listenOnOff = 1;
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                listenBtn.setBackground(getResources().getDrawable(R.drawable.listen_button3));
            }
        }
    ...
    private void toggleAddErase() {
        ...
        if (mode == 0) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                addEraseButton.setBackground(getResources().getDrawable(R.drawable.erase_button));
            }
        }
    }
    ...
    // prepares grid for regular, quiz, sudoku, listening compre modes
